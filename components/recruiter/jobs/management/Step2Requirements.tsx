    ...
    <div className="rounded-xl bg-white p-6 shadow-sm space-y-8 text-midnight">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {EXPERIENCE_LEVELS.map((level) => (
              <button
                ...
                className={`${FIELD_HEIGHT} flex items-center rounded-lg border px-3 text-sm font-medium transition ${data.experienceLevel === level
                    ...
                    {selectedSkills.map((skill) => (
                      <tr key={skill.skillId} className="align-middle">
                        ...
                        <td className="px-4 py-3">
                          ...
                          >
                            <SelectTrigger className="h-9! box-border w-37.5">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
      ...
      <div className="space-y-3">
        ...
        <textarea
          ...
          className={`min-h-48 w-full rounded-lg border bg-white p-3 text-midnight placeholder-slate/50 outline-none focus:ring-2 transition ${descriptionErr
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-slate/15">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 text-slate transition-transform ${isAddFormOpen ? "rotate-180" : ""
                      }`}
                  />
                </button>
              ...
              {(skillLibraryError ?? skillLibraryStatus) && (
                <div
                  className={`flex items-center gap-2 rounded-lg border px-3 py-2 text-xs font-medium ${skillLibraryError
                ...
                {skillCategories.length > 0 && (
                  <div className="flex flex-wrap gap-1.5">
                    <button
                      ...
                      className={`rounded-full px-3 py-1 text-xs font-semibold transition ${libraryFilterCategory === "__all__"
                    ...
                    {skillCategories.map((cat) => {
                      ...
                      return (
                        <button
                          ...
                          className={`rounded-full px-3 py-1 text-xs font-semibold transition ${libraryFilterCategory === cat
                              ? "bg-primary text-white"
                              : "border border-slate/20 text-slate hover:border-primary/30 hover:text-midnight"
                            }`}
                        >
                        ...
                        <div className="space-y-1">
                          {skills.map((skill) => {
                            ...
                            return (
                              <div
                                key={skill.id}
                                className={`group rounded-lg border transition ${isEditing
